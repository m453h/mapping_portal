...
class SpatialReportController extends Controller
{


    /**
     * @Route("/administration/spatial-report-builder", name="spatial_report_builder")
    ...
    public function reportAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid())
        {
            ...
            return $this->render('administration/main/app.spatial.html.twig',$data);
