...
class MenuBuilder
{
    ...
    public function createMainMenu()
    {
        ...
        else
        {
           ...
           $permissions = $this->entityManager->getRepository('AppBundle:UserAccounts\Permission')
               ->getAllUserACLs($roleIds);
           ...
           if(in_array('Configuration',$permissions))
           {
            ...
            if(in_array('Location',$permissions))
            {
           ...
           if(in_array('DataCollector',$permissions) || in_array('PortalUsers',$permissions) )
           {
